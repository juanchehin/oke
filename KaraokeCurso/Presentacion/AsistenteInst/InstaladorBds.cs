...
{
    public partial class InstaladorBds : Form
    {
        public InstaladorBds()
        {
            InitializeComponent();
        }
        ...
        private void InstaladorBds_Load(object sender, EventArgs e)
        {
            centrarPaneles();
            Reemplazar();
        ...
        private void Reemplazar()
        {
            ...
            txtCrear_procedimientos.Text = txtCrear_procedimientos.Text.Replace("KARAOKECURSO", TXTbasededatos.Text);
            //********
